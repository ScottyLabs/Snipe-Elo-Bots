...
function formatDiscordHelpText(guild: Guild, db: EloDb): string {
  ...
  return [
    ...
    "",
    "**Polls** _(Slack bot only — not a Discord slash command)_",
    "• `/poll list` — numbered active polls in the Slack snipe channel.",
    "• `/poll check <n>` — the bot pings you in that poll’s thread.",
    "• `/poll <question> | <opt1> | <opt2> [| …] [| duration]` — post a poll; optional time limit only as the last segment (`2h`, `7d`, …). Omit it for no deadline.",
    "• Vote in the poll’s **thread** with a message that is only `1`, `2`, … (you can change your vote).",
    "",
    "**Scoring / moderation**",
